...
7.  Click **Watch List**.
    ...
    The Watch List tab appears.

8.  Click **Add Watch List**.
    
    The Add Watch List dialog appears.

9.  Select or clear email addresses from the list of email addresses on
    the account.

10. Type or remove an email address for any **Additional User**;
    separate multiple users' email addresses with commas.

11. Click **Add Watch List**.
